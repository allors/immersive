// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CanvasTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class CanvasTest : AvaloniaTest
    {
        ...
        {
            var tester = new CanvasTester("canvas1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.Canvas>(tester.Target);
        }
    }
}
