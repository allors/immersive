// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UserControlTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class UserControlTest : AvaloniaTest
    {
        ...
        {
            var tester = new UserControlTester("userControl1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<UserControl>(tester.Target);
        }
    }
}
