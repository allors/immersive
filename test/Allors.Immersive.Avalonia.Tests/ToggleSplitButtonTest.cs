// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ToggleSplitButtonTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class ToggleSplitButtonTest : AvaloniaTest
    {
        private DefaultWindow window;

        public ToggleSplitButtonTest()
        {
        ...
        {
            var tester = new ToggleSplitButtonTester("toggleSplitButton1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.ToggleSplitButton>(tester.Target);
        }
