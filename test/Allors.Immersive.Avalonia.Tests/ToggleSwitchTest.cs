// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ToggleSwitchTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class ToggleSwitchTest : AvaloniaTest
    {
        ...
        {
            var tester = new ToggleSwitchTester("toggleSwitch1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.ToggleSwitch>(tester.Target);
        }
    }
}
