// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AutoCompleteBoxTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class AutoCompleteBoxTest : AvaloniaTest
    {
        ...
        {
            var tester = new AutoCompleteBoxTester("autoCompleteBox1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.AutoCompleteBox>(tester.Target);
        }
    }
}
