// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WrapPanelTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class WrapPanelTest : AvaloniaTest
    {
        ...
        {
            var tester = new WrapPanelTester("wrapPanel1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.WrapPanel>(tester.Target);
        }
    }
}
