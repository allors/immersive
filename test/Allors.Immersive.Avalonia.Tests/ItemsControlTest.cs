// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ItemsControlTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class ItemsControlTest : AvaloniaTest
    {
        ...
        {
            var tester = new ItemsControlTester("itemsControl1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<ItemsControl>(tester.Target);
        }
    }
}
