// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CalendarDatePickerTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class CalendarDatePickerTest : AvaloniaTest
    {
        ...
        {
            var tester = new CalendarDatePickerTester("calendarDatePicker1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.CalendarDatePicker>(tester.Target);
        }
    }
}
