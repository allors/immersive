// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ToggleButtonTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class ToggleButtonTest : AvaloniaTest
    {
        ...
        {
            var tester = new ToggleButtonTester("toggleButton1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.Primitives.ToggleButton>(tester.Target);
        }
