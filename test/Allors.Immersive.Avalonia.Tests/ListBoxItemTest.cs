// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ListBoxItemTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class ListBoxItemTest : AvaloniaTest
    {
        ...
        {
            var tester = new ListBoxItemTester("listBoxItem1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.ListBoxItem>(tester.Target);
        }
    }
}
