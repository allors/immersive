// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ScrollViewerTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class ScrollViewerTest : AvaloniaTest
    {
        ...
        {
            var tester = new ScrollViewerTester("scrollViewer1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.ScrollViewer>(tester.Target);
        }
    }
}
