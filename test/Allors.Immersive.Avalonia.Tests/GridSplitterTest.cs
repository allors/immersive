// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GridSplitterTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class GridSplitterTest : AvaloniaTest
    {
        ...
        {
            var tester = new GridSplitterTester("gridSplitter1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.GridSplitter>(tester.Target);
        }
    }
}
