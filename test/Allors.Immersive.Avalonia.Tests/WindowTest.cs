// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WindowTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class WindowTest : AvaloniaTest
    {
        ...
        [Fact]
        public void FindHandleByObject()
        {
            var handle = Session.Singleton.FindHandle(this.window);
        ...
        {
            var tester = new WindowTester("defaultWindow");
