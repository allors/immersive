...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class DatePickerTest : AvaloniaTest
    {
        ...
        {
            var tester = new DatePickerTester("datePicker1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.DatePicker>(tester.Target);
        }
    }
}
