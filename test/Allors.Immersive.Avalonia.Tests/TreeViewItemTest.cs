// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TreeViewItemTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class TreeViewItemTest : AvaloniaTest
    {
        ...
        {
            var tester = new TreeViewItemTester("treeViewItem1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.TreeViewItem>(tester.Target);
        }
    }
}
