// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TextBlockTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class TextBlockTest : AvaloniaTest
    {
        ...
        {
            var tester = new TextBlockTester("textBlock1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<TextBlock>(tester.Target);
        }
    }
}
