// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CarouselTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class CarouselTest : AvaloniaTest
    {
        ...
        {
            var tester = new CarouselTester("carousel1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<Carousel>(tester.Target);
        }
    }
}
