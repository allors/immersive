// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GridTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class GridTest : AvaloniaTest
    {
        ...
        {
            var tester = new GridTester("grid1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<global::Avalonia.Controls.Grid>(tester.Target);
        }
    }
}
