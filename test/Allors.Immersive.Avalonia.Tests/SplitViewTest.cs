// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SplitViewTest.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Tests
{
    ...
    public class SplitViewTest : AvaloniaTest
    {
        ...
        {
            var tester = new SplitViewTester("splitView1");
            Assert.NotNull(tester.Target);
            Assert.IsAssignableFrom<SplitView>(tester.Target);
        }
    }
}
