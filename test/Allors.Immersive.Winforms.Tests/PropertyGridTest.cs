...
namespace Allors.Immersive.Winforms.Tests
{
    ...
    public class PropertyGridTest : WinformsTest
    {
        ...
        public void FindTesterByName()
        {
            ...
            Assert.IsAssignableFrom<PropertyGrid>(tester.Target);
        }
        ...
        public void FindPropertyGridItem()
        {
            ...
            Assert.Equal("A First X", aFirstX.Value.ToString());
            Assert.Equal("B First X", bFirstX.Value.ToString());
            Assert.Equal("C First X", cFirstX.Value.ToString());
        }
    }
}