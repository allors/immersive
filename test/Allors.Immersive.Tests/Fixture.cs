...
namespace Allors.Immersive.Tests
{
    public static class Fixture
    {
        ...
        static Fixture()
        {
            ...
            var sourcePath = Directory.GetFiles(outputDir, "Allors.Immersive.AssemblyToProcess.dll").First();
            ...
            AssemblyPath = Path.Combine(tempDir, "Allors.Immersive.AssemblyToProcess.dll");
