// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Viewbox.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Substitutes
{
    ...
    [SubstituteClass]
    public class Viewbox : global::Avalonia.Controls.Viewbox, ISubstitute
    {
        protected override System.Type StyleKeyOverride => typeof(global::Avalonia.Controls.Viewbox);
