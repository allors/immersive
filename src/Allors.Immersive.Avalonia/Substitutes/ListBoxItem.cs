// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ListBoxItem.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Substitutes
{
    ...
    [SubstituteClass]
    public class ListBoxItem : global::Avalonia.Controls.ListBoxItem, ISubstitute
    {
        protected override System.Type StyleKeyOverride => typeof(global::Avalonia.Controls.ListBoxItem);
