// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Carousel.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Substitutes
{
    ...
    [SubstituteClass]
    public class Carousel : global::Avalonia.Controls.Carousel, ISubstitute
    {
        protected override System.Type StyleKeyOverride => typeof(global::Avalonia.Controls.Carousel);
