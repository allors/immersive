// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Separator.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Substitutes
{
    ...
    [SubstituteClass]
    public class Separator : global::Avalonia.Controls.Separator, ISubstitute
    {
        protected override System.Type StyleKeyOverride => typeof(global::Avalonia.Controls.Separator);
