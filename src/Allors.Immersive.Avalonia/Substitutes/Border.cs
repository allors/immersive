// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Border.cs" company="allors bvba">
...
namespace Allors.Immersive.Avalonia.Substitutes
{
    ...
    [SubstituteClass]
    public class Border : global::Avalonia.Controls.Border, ISubstitute
    {
        protected override System.Type StyleKeyOverride => typeof(global::Avalonia.Controls.Border);
