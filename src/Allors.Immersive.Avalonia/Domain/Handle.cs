...
namespace Allors.Immersive.Avalonia.Domain
{
    ...
    public class Handle
    {
        ...
        public global::Avalonia.Controls.Control Control
        {
            get { return this.substitute as global::Avalonia.Controls.Control; }
        }
        ...
        public Handle Parent
        {
            get
            {
                if (this.Control is StyledElement styled)
                {
                    var parent = styled.Parent;
