...
namespace Allors.Immersive.Attributes
{
    using System;
    ...
    public class SubstituteMethodAttribute : Attribute
    {
        ...
        private readonly string _substitutableMethodName;
        ...
        {
            this._substitutableMethodName = methodName;
        }
        ...
        /// </summary>
        public string SubstitutableMethodName
        {
            get { return this._substitutableMethodName; }
        }
    }
}